...
*/
const A187 = '👾BOT✘RFDI👾'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/rfdi.anz'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6285282530690'; // JANGAN UBAH-UBAH INFO!!!
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] MrRfdi01 ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @rfdi.anz`))
...
conn.sendMessage(id, 'no toxic' ,MessageType.text);
}
else if (text == '#owner'){
conn.sendMessage(id, ' *Owner MrRfdi01 wa.me/+6285282538690* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Creator MrRfdi01 wa.me/+6285282538690* ' ,MessageType.text);
}
else if (text == 'Pagi'){
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾BOT✘RFDI👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/rfdi.anz' ,MessageType.text);
}
else if (text == '#menu1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾BOT✘RFDI👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/rfdi.anz' ,MessageType.text);
}
